...
process.on('message', (arg) => {
  ...
  if (!count) {
    ...
    let launched = {
      ...
      message: `Campaign Launched Successfully : Your campaign ${campaign.title} has started running`,
    }
    ...
    client.on('disconnected', (reason) => {
      ...
      let terminateAlert = {
        ...
        info: 'error',
        status: 'error',
        title: `Campaign ${campaign.title} : has been disconnected`,
        message: `There was an error connecting Campaign ${campaign.title} - ${reason}`,
      }
    ...
    client.on('auth_failure', (message) => {
      ...
      let terminateAlert = {
        ...
        info: 'error',
        status: 'error',
        title: `Campaign ${campaign.title} : Auth Failed`,
        message: `There was an error authenticating Bot ${campaign.title} - ${message}`,
      }
      process.send(terminateAlert)
    })
